...
export const newArrivalsData: Product[] = [
  {
    ...
    rating: 4.5,
    description: "Jasmine Bloom Perfume is a luxurious and unique fragrance that combines the rich, warm notes of jasmine with the deep, mysterious notes of musk. This attar is perfect for those who want to make a bold statement and stand out from the crowd.",
    gender: ['female'],
    colors: [
      {
        name: "Pink",
  ...
  },
  {
    ...
    rating: 3.5,
    description: "Oud Mystique Attar is a luxurious and unique fragrance that combines the rich, warm notes of oud with the deep, mysterious notes of musk. This attar is perfect for those who want to make a bold statement and stand out from the crowd.",
    gender: ['male', 'unisex'],
    colors: [
      {
        name: "Brown",
  ...
  },
  {
    ...
    rating: 4.5,
    description: "Lemon Grove Spray is a refreshing and invigorating fragrance that combines the zesty notes of lemon with subtle floral undertones. Perfect for daily wear and special occasions.",
    gender: ['unisex'],
    colors: [
      {
        name: "Yellow",
