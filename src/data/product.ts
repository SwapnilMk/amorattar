...
export const relatedProductData: Product[] = [
  {
    ...
    volumeOptions: [
      { ml: 6, price: 242, discount: 20, discountedPrice: 193.6 },
      { ml: 12, price: 450, discount: 20, discountedPrice: 360 },
      { ml: 20, price: 750, discount: 20, discountedPrice: 600 }
    ],
    selectedVolume: { ml: 6, price: 242, discount: 20, discountedPrice: 193.6 },
    isSale: true,
    specifications: [
  ...
  },
  {
    ...
    volumeOptions: [
      { ml: 6, price: 180, discount: 0, discountedPrice: 180 },
      { ml: 12, price: 340, discount: 0, discountedPrice: 340 },
      { ml: 20, price: 550, discount: 0, discountedPrice: 550 }
    ],
    selectedVolume: { ml: 6, price: 180, discount: 0, discountedPrice: 180 },
    isSale: false,
    specifications: [
  ...
  },
  {
    ...
    volumeOptions: [
      { ml: 6, price: 150, discount: 30, discountedPrice: 105 },
      { ml: 12, price: 280, discount: 30, discountedPrice: 196 },
      { ml: 20, price: 450, discount: 30, discountedPrice: 315 }
    ],
    selectedVolume: { ml: 6, price: 150, discount: 30, discountedPrice: 105 },
    isSale: true,
    specifications: [
      { key: 'Fragrance Type', value: 'Attar' },
      { key: 'Longevity', value: '8-10 hours' },
