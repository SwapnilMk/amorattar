...
function Banner() {
  ...
  return (
    <div className='relative mx-auto max-w-7xl overflow-hidden rounded-lg bg-gradient-to-br from-amber-50 via-amber-100 to-amber-50 p-6 shadow-lg'>
      {/* Enhanced background pattern */}
      <div className='absolute inset-0 opacity-20'>
        <div className='absolute -left-8 -top-8 h-32 w-32 animate-pulse rounded-full bg-amber-500'></div>
        <div className='absolute bottom-0 right-0 h-40 w-40 rounded-full bg-amber-600 blur-md'></div>
        <div className='absolute bottom-12 left-1/3 h-24 w-24 rounded-full bg-amber-400 blur-sm'></div>
        <div className='absolute right-1/4 top-1/2 h-16 w-16 rounded-full bg-amber-600'></div>
