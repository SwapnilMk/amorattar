      ...
      <section className="max-w-frame mx-auto bg-[#F0F0F0] px-6 pb-6 pt-10 md:p-[70px] rounded-[40px] text-center">
        ...
        >
          <DressStyleCard
            title="Floral"
            url="/shop#floral"
            className="md:max-w-[260px] lg:max-w-[360px] xl:max-w-[407px] h-[190px] bg-[url('/images/fragrance-style-floral.png')]"
          />
          <DressStyleCard
            title="Woody"
            url="/shop#woody"
            className="md:max-w-[684px] h-[190px] bg-[url('/images/fragrance-style-woody.png')]"
          />
        </motion.div>
        <motion.div
          initial={{ y: "100px", opacity: 0 }}
        ...
        >
          <DressStyleCard
            title="Citrus"
            url="/shop#citrus"
            className="md:max-w-[684px] h-[190px] bg-[url('/images/fragrance-style-citrus.png')]"
          />
          <DressStyleCard
            title="Oriental"
            url="/shop#oriental"
            className="md:max-w-[260px] lg:max-w-[360px] xl:max-w-[407px] h-[190px] bg-[url('/images/fragrance-style-oriental.png')]"
          />
        </motion.div>
      </section>
    </div>
